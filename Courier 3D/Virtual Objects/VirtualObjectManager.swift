...
class VirtualObjectManager {
    ...
    // A list of Virtual Object
	var virtualObjects = [VirtualObject]()
    
    // Last used object( Used to retreive the object to interact)
    ...
    init(updateQueue: DispatchQueue) {
        // Update queue is Serial Queue instead of in Main Thread
        // Which means that operation in this queue executed one by one
    ...
    /**
     - parameters:
     - _: the name of this model(there must be a image with this name in asset)
     */
